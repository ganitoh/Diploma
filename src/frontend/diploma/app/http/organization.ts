...
import { ICreateOrganiaiton, IOrganiaiton, IShortOrganiaiton } from "../models/organization";
...
export const getTopOrganizationByRating = async (top: number): Promise<IResponse<IShortOrganiaiton[]>> =>
    (await organizaitonClient.get("/Organization/getTopOrganizationByRating", { params: { top }})).data
